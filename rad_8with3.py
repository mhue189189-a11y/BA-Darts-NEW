...
def plot_3dart_4point_comparison(results3):
    ...
    fig.suptitle("Radienvergleich: 8-Punkte-Checkout mit 3 Darts (Optimum)", fontsize=16)
    ax.plot(sig, results3["r1_opt"], 'o-', lw=2.5, label='r1_opt (1. Dart)', color='darkblue')
    ax.plot(sig, results3['r1_naive'], 's--', lw=2, label='r_naive = 166 mm', color='darkorange')
